...
` });
        ...
        switch (cmd) {
            case 'help':
                terminalHistory.value.push({ type: 'output', text: `Comandos úteis:
...
<template>
    <div :class="{ 'dark': isDark }">
        <div class="min-h-screen flex flex-col bg-[#f3f3f3] dark:bg-[#050505] text-[#111111] dark:text-[#f3f3f3] font-sans selection:bg-[#FFD60A] selection:text-[#111111] transition-colors duration-300">

            <nav class="border-b-4 border-[#111111] dark:border-[#2a2a2a] sticky top-0 z-40 bg-[#f3f3f3] dark:bg-[#050505] w-full transition-colors duration-300">
                <div class="container mx-auto px-6 py-3 flex justify-between items-center">
                    ...
                    <a href="#inicio" class="flex items-center gap-4 z-50 group cursor-pointer">
                        <div class="relative w-12 h-10 flex items-center justify-center">
                            <div class="absolute inset-0 bg-[#111111] translate-x-[4px] translate-y-[4px] transition-transform group-hover:translate-x-[2px] group-hover:translate-y-[2px]"></div>
                            <span class="relative z-10 bg-[#FFD60A] border-2 border-[#111111] text-[#111111] px-3 py-1 font-mono font-bold text-xl flex items-center justify-center w-full h-full transition-transform group-hover:translate-x-[2px] group-hover:translate-y-[2px]">
                                >_
                            </span>
                        </div>
                            ...
                            <a :href="item.id"
                                :class="[ 
                                   ...
                                   activeSection === item.id.substring(1) 
                                       ? 'border-[#111111] dark:border-[#ffffff] bg-[#FFD60A] text-[#111111] shadow-[3px_3px_0px_0px_#111111] dark:shadow-[3px_3px_0px_0px_#000000]' 
                                       : 'border-transparent text-[#111111] dark:text-[#f3f3f3] hover:border-[#111111] dark:hover:border-[#ffffff] hover:bg-[#FFD60A] dark:hover:bg-[#FFD60A] hover:text-[#111111] dark:hover:text-[#111111] hover:shadow-[3px_3px_0px_0px_#111111] dark:hover:shadow-[3px_3px_0px_0px_#000000]'
                               ]">
                                <span class="font-mono font-black mr-2 text-base transition-opacity duration-200" 
                                      :class="activeSection === item.id.substring(1) ? 'opacity-100 text-[#111111]' : 'opacity-0 group-hover:opacity-100 text-[#111111] dark:text-[#111111]'">$</span>
                                {{ item.label }}
                            </a>
                        </li>
                    </ul>

                    <div class="hidden md:flex gap-4 text-xl border-l-2 border-[#2a2a2a] pl-6 items-center text-[#111111] dark:text-[#f3f3f3]">
                        <a href="https://github.com/Elliton-Luis" target="_blank" class="hover:text-[#FFD60A] hover:scale-110 transition-all"><i class="bi bi-github"></i></a>
                        <a href="https://www.linkedin.com/in/elliton-luis-correia-da-silva-junior-9779452b3" target="_blank" class="hover:text-[#0A66C2] hover:scale-110 transition-all"><i class="bi bi-linkedin"></i></a>
                        <a href="https://wa.me/75999488795" target="_blank" class="hover:text-[#25D366] hover:scale-110 transition-all"><i class="bi bi-whatsapp"></i></a>

                        <button @click="toggleTheme" class="ml-2 bg-[#f3f3f3] dark:bg-[#111111] border-2 border-[#111111] dark:border-[#f3f3f3] px-3 py-1 text-sm font-mono shadow-[2px_2px_0px_0px_#111111] dark:shadow-[2px_2px_0px_0px_#000000] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none hover:bg-[#FFD60A] dark:hover:bg-[#FFD60A] dark:hover:text-[#111111] dark:hover:border-[#111111] transition-all">
            ...
            <div v-if="isMenuOpen" @click="toggleMenu" class="fixed inset-0 bg-black/80 z-30 md:hidden backdrop-blur-sm transition-opacity duration-300"></div>

            <aside :class="isMenuOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed top-0 left-0 h-full w-[80%] max-w-sm bg-[#f3f3f3] dark:bg-[#050505] border-r-4 border-[#111111] dark:border-[#2a2a2a] z-40 transform transition-transform duration-300 ease-in-out md:hidden shadow-[10px_0px_0px_0px_#111111] dark:shadow-[10px_0px_0px_0px_#000000] flex flex-col pt-28 pb-6 px-6">
                <ul class="flex flex-col gap-4 text-lg font-bold uppercase tracking-wider font-sans text-[#111111] dark:text-[#f3f3f3]">
                    <li v-for="(item, index) in navItems" :key="index">
                        <a :href="item.id" @click="toggleMenu"
                            :class="[
                            ...
                            <span :class="['font-mono font-black mr-3 transition-opacity duration-200', activeSection === item.id.substring(1) ? 'opacity-100 text-[#111111]' : 'opacity-0 group-hover:opacity-100 text-[#111111] dark:text-[#111111]']">$</span>
                            {{ item.label }}
                        </a>
                    </li>
                </ul>
                <div class="mt-auto">
                    <div class="bg-[#ffffff] dark:bg-[#111111] p-4 border-2 border-[#111111] dark:border-[#2a2a2a] shadow-[4px_4px_0px_0px_#111111] dark:shadow-[4px_4px_0px_0px_#000000]">
                        <p class="font-mono text-xs text-center mb-4 text-[#111111] dark:text-[#f3f3f3]">Conecte-se comigo:</p>
                        <div class="flex gap-6 text-3xl text-[#111111] dark:text-[#f3f3f3] justify-center items-center">
                            <a href="https://github.com/Elliton-Luis" target="_blank" class="hover:text-[#FFD60A] transition-colors"><i class="bi bi-github"></i></a>
                            <a href="https://www.linkedin.com/in/elliton-luis-correia-da-silva-junior-9779452b3" target="_blank" class="hover:text-[#0A66C2] transition-colors"><i class="bi bi-linkedin"></i></a>
                            <a href="https://wa.me/75999488795" target="_blank" class="hover:text-[#25D366] transition-colors"><i class="bi bi-whatsapp"></i></a>
                            <button @click="toggleTheme" class="ml-2 pl-4 border-l-2 border-[#2a2a2a] hover:text-[#FFD60A] transition-colors">
                                <i class="bi" :class="isDark ? 'bi-sun-fill' : 'bi-moon-stars-fill'"></i>
                            </button>
                        </div>
                    </div>
            ...
            <main class="flex-grow container mx-auto px-4 sm:px-6 relative">
                ...
                <section id="inicio" class="min-h-[85vh] flex flex-col justify-center pb-12 scroll-mt-20 pt-10">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        <div class="space-y-8 animate-fade-in-up">
                            <div class="space-y-4">
                                <div class="inline-block bg-[#111111] text-[#ffffff] px-3 py-1 font-mono text-sm border border-[#111111] shadow-[2px_2px_0px_0px_#FFD60A]">
                                    #!/bin/bash
                                </div>
                                <h1 class="font-mono text-4xl md:text-5xl lg:text-6xl font-black leading-tight tracking-tight text-[#111111] dark:text-[#ffffff]">
                                    <span class="bg-[#FFD60A] text-[#111111] px-2 py-1 inline-block transform -rotate-1 shadow-[3px_3px_0px_0px_#111111] dark:shadow-[3px_3px_0px_0px_#ffffff]">"Elliton Luís"</span>
                                </h1>
                                <h2 class="font-mono text-xl md:text-2xl font-bold text-[#2a2a2a] dark:text-[#f3f3f3] border-l-4 border-[#FFD60A] pl-4">
                            ...
                            <p class="text-lg font-medium leading-relaxed max-w-lg text-[#111111] dark:text-[#f3f3f3]">
                                Focado na construção de aplicações reais, escaláveis e deployáveis. Minha abordagem une
                                o domínio do ecossistema <strong class="font-bold text-[#111111] dark:text-[#ffffff]">PHP moderno</strong> à
                                autonomia de infraestrutura <strong class="font-bold text-[#111111] dark:text-[#ffffff]">Linux</strong> e integração de
                        ...
                        <div class="flex justify-center lg:justify-end group">
                            <div class="relative w-full max-w-md transition-transform duration-500 ease-out group-hover:-translate-y-2">
                                <div class="absolute top-4 right-[-16px] w-full h-full bg-[#FFD60A] border-2 border-[#111111] dark:border-[#2a2a2a] transition-transform duration-500 group-hover:translate-x-2 group-hover:translate-y-2"></div>
                                <div class="bg-[#ffffff] dark:bg-[#111111] border-2 border-[#111111] dark:border-[#2a2a2a] relative z-10 flex flex-col">
                                    <div class="bg-[#111111] text-[#ffffff] font-mono text-xs py-2 px-3 flex justify-between items-center border-b-2 border-[#111111] dark:border-[#2a2a2a]">
                                    ...
                                    <div class="bg-[#f3f3f3] dark:bg-[#050505] h-[320px] sm:h-[420px] lg:h-[500px] w-full flex items-center justify-center relative overflow-hidden">
                                        <img src="../assets/images/foto_perfil.png" alt="Elliton Luís" class="object-cover w-full h-full transition-transform duration-500 hover:scale-105" />
                                        <div class="absolute bottom-4 left-4 bg-[#111111] text-[#ffffff] px-3 py-1.5 text-xs font-mono border border-[#FFD60A] shadow-[2px_2px_0px_0px_#FFD60A] animate-pulse">
                                            $ status: online<span class="animate-ping inline-block w-1.5 h-3 bg-[#FFD60A] ml-1 align-middle"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section id="habilidades" class="min-h-[90vh] flex flex-col justify-start pt-12 pb-12">
                    <div class="space-y-8 mb-12">
                        <div>
                            <h2 class="font-mono text-3xl font-bold mb-4 text-[#111111] dark:text-[#ffffff] flex items-center">
                                <span class="relative inline-flex w-12 h-10 mr-4 items-center justify-center">
                                    ...
                                    <span class="relative z-10 bg-[#FFD60A] dark:bg-[#111111] border-2 border-[#111111] dark:border-[#2a2a2a] text-[#111111] dark:text-[#FFD60A] w-full h-full flex items-center justify-center font-bold text-xl">
                                        >_
                                    </span>
                                </span>
                                Habilidades
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="border-2 border-[#111111] dark:border-[#2a2a2a] bg-[#ffffff] dark:bg-[#111111] p-8 shadow-[6px_6px_0px_0px_#111111] dark:shadow-[6px_6px_0px_0px_#FFD60A] hover:-translate-y-2 transition-all duration-300 flex flex-col">
                                <h3 class="inline-block px-2 py-1 font-mono font-bold text-xl mb-4 bg-[#111111] text-[#ffffff] dark:bg-transparent dark:text-[#ffffff] transition-colors self-start">
                                ...
                                <p class="text-sm leading-relaxed text-[#111111] dark:text-[#f3f3f3]">Desenvolvimento
                                    orientado à responsividade total, garantindo performance e UX impecável em qualquer
                                    dispositivo, priorizando a experiência mobile desde a base.</p>
                            </div>
                            <div class="border-2 border-[#111111] dark:border-[#2a2a2a] bg-[#ffffff] dark:bg-[#111111] p-8 shadow-[6px_6px_0px_0px_#111111] dark:shadow-[6px_6px_0px_0px_#FFD60A] hover:-translate-y-2 transition-all duration-300 flex flex-col">
                                <h3 class="inline-block px-2 py-1 font-mono font-bold text-xl mb-4 bg-[#111111] text-[#ffffff] dark:bg-transparent dark:text-[#ffffff] transition-colors self-start">
                                    <i class="bi bi-diagram-3 mr-2 text-[#FFD60A]"></i>Arquitetura de Sistemas
                                </h3>
                                <p class="text-sm leading-relaxed text-[#111111] dark:text-[#f3f3f3]">Modelagem profunda
                                    de domínios complexos, construção de APIs RESTful robustas e bancos de dados
                                    otimizados para escalar com segurança e eficiência.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div class="border-2 border-[#111111] dark:border-[#2a2a2a] bg-[#ffffff] dark:bg-[#111111] p-6 shadow-[6px_6px_0px_0px_#111111] dark:shadow-[6px_6px_0px_0px_#FFD60A] hover:-translate-y-1 transition-all duration-300 flex flex-col">
                                <h3 class="inline-block px-2 py-1 font-mono font-bold text-lg mb-4 bg-[#111111] text-[#ffffff] dark:bg-transparent dark:text-[#ffffff] transition-colors self-start">
                                    <i class="bi bi-code-slash mr-2 text-[#FFD60A]"></i>Fundamentos & CS
                                </h3>
                                <div class="flex flex-wrap gap-2 mb-3">
                                    <span class="px-3 py-1 border-2 border-[#111111] bg-[#e34c26] text-[#ffffff] text-xs font-mono font-bold shadow-[2px_2px_0px_0px_#111111]">HTML5 / CSS3</span>
                                    <span class="px-3 py-1 border-2 border-[#111111] bg-[#f0db4f] text-[#111111] text-xs font-mono font-bold shadow-[2px_2px_0px_0px_#111111]">JS (ES6+)</span>
                                    <span class="px-3 py-1 border-2 border-[#111111] bg-[#4a90e2] text-[#ffffff] text-xs font-mono font-bold shadow-[2px_2px_0px_0px_#111111]">Estruturas de Dados</span>
                                    <span class="px-3 py-1 border-2 border-[#111111] bg-[#27c93f] text-[#111111] text-xs font-mono font-bold shadow-[2px_2px_0px_0px_#111111]">Busca & Ordenação</span>
                                </div>
                            </div>

                            <div class="border-2 border-[#111111] dark:border-[#2a2a2a] bg-[#ffffff] dark:bg-[#111111] p-6 shadow-[6px_6px_0px_0px_#111111] dark:shadow-[6px_6px_0px_0px_#FFD60A] hover:-translate-y-1 transition-all duration-300 lg:row-span-2 flex flex-col">
                                <h3 class="inline-block px-2 py-1 font-mono font-bold text-lg mb-4 bg-[#111111] text-[#ffffff] dark:bg-transparent dark:text-[#ffffff] transition-colors self-start">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <ul class="text-sm text-[#111111] dark:text-[#f3f3f3] space-y-3 font-mono">
                                        <li>› <strong class="bg-[#27c93f] text-[#111111] px-1.5 py-0.5 border border-[#111111] shadow-[2px_2px_0px_0px_#111111] mr-1">Eloquent ORM</strong> Queries eficientes</li>
                                        <li>› <strong class="bg-[#ff5f56] text-[#ffffff] px-1.5 py-0.5 border border-[#111111] shadow-[2px_2px_0px_0px_#111111] mr-1">Arquitetura</strong> MVC, SOLID, Clean Code</li>
                            ...
                            <div class="border-2 border-[#111111] dark:border-[#2a2a2a] bg-[#ffffff] dark:bg-[#111111] p-6 shadow-[6px_6px_0px_0px_#111111] dark:shadow-[6px_6px_0px_0px_#FFD60A] hover:-translate-y-1 transition-all duration-300 flex flex-col">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <span class="px-3 py-1 border-2 border-[#111111] bg-[#9333ea] text-[#ffffff] text-xs font-mono font-bold shadow-[2px_2px_0px_0px_#111111]">Embeddings</span>
                                    <span class="px-3 py-1 border-2 border-[#111111] bg-[#9333ea] text-[#ffffff] text-xs font-mono font-bold shadow-[2px_2px_0px_0px_#111111]">Chunking</span>
                                    <span class="px-3 py-1 border-2 border-[#111111] bg-[#db2777] text-[#ffffff] text-xs font-mono font-bold shadow-[2px_2px_0px_0px_#111111]">Agentes de IA</span>
                                </div>
                            </div>
                            ...
                            <div class="border-2 border-[#111111] dark:border-[#2a2a2a] bg-[#ffffff] dark:bg-[#111111] p-6 shadow-[6px_6px_0px_0px_#111111] dark:shadow-[6px_6px_0px_0px_#FFD60A] hover:-translate-y-1 transition-all duration-300 flex flex-col">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <span class="px-3 py-1 border-2 border-[#111111] bg-[#6366f1] text-[#ffffff] text-xs font-mono font-bold shadow-[2px_2px_0px_0px_#111111]">Bootstrap</span>
                                </div>
                            </div>
                            ...
                            <div class="border-2 border-[#111111] dark:border-[#2a2a2a] bg-[#ffffff] dark:bg-[#111111] p-6 shadow-[6px_6px_0px_0px_#111111] dark:shadow-[6px_6px_0px_0px_#FFD60A] hover:-translate-y-1 transition-all duration-300 flex flex-col">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <span class="px-3 py-1 border-2 border-[#111111] bg-[#111111] text-[#ffffff] text-xs font-mono font-bold shadow-[2px_2px_0px_0px_#FFD60A] dark:shadow-[2px_2px_0px_0px_#ffffff]">Linux</span>
                                    <span class="px-3 py-1 border-2 border-[#111111] bg-[#0078d7] text-[#ffffff] text-xs font-mono font-bold shadow-[2px_2px_0px_0px_#111111]">WSL</span>
                                    <span class="px-3 py-1 border-2 border-[#111111] bg-[#0ea5e9] text-[#ffffff] text-xs font-mono font-bold shadow-[2px_2px_0px_0px_#111111]">Virtualização</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id="experiencia" class="min-h-[70vh] flex flex-col justify-start pt-12 pb-12">
                    <div class="space-y-8">
                        ...
                        <div class="relative border-l-4 border-[#111111] dark:border-[#2a2a2a] ml-4 md:ml-8 mt-8 space-y-12">
                            
                            <div class="relative pl-8 group">
                                <div class="absolute -left-[14px] top-1 w-6 h-6 bg-[#FFD60A] border-4 border-[#111111] dark:border-[#f3f3f3] rounded-full group-hover:scale-125 transition-transform"></div>
                                <span class="font-mono text-xs font-bold text-[#111111] bg-[#f3f3f3] border-2 border-[#111111] px-2 py-1 shadow-[2px_2px_0px_0px_#111111]">commit v1.3</span>
                                <h3 class="font-mono font-bold text-xl mt-3 text-[#111111] dark:text-[#ffffff]">feat: Foco em Ferramentas e IA</h3>
                                <p class="text-sm mt-2 text-[#111111] dark:text-[#f3f3f3] leading-relaxed max-w-2xl">
                                    Desenvolvendo ferramentas de gestão financeira (FinTrack via CLI/Web), integração de Agentes IA para gerar commits automatizados no Git e aprofundando o controle de hardware com Java (AlphaControl).
                                </p>
                            </div>

                            <div class="relative pl-8 group">
                                <div class="absolute -left-[14px] top-1 w-6 h-6 bg-[#42b883] border-4 border-[#111111] dark:border-[#f3f3f3] rounded-full group-hover:scale-125 transition-transform"></div>
                                <span class="font-mono text-xs font-bold text-[#111111] bg-[#f3f3f3] border-2 border-[#111111] px-2 py-1 shadow-[2px_2px_0px_0px_#111111]">commit v1.2</span>
                                <h3 class="font-mono font-bold text-xl mt-3 text-[#111111] dark:text-[#ffffff]">merge branch 'front-end' into main</h3>
                                <p class="text-sm mt-2 text-[#111111] dark:text-[#f3f3f3] leading-relaxed max-w-2xl">
                                    Integrando o ecossistema Vue.js aos projetos, construindo interfaces reativas e modernas, complementando a base sólida do backend.
                                </p>
                            </div>

                            <div class="relative pl-8 group">
                                <div class="absolute -left-[14px] top-1 w-6 h-6 bg-[#ff2d20] border-4 border-[#111111] dark:border-[#f3f3f3] rounded-full group-hover:scale-125 transition-transform"></div>
                                <span class="font-mono text-xs font-bold text-[#111111] bg-[#f3f3f3] border-2 border-[#111111] px-2 py-1 shadow-[2px_2px_0px_0px_#111111]">commit v1.1</span>
                                <h3 class="font-mono font-bold text-xl mt-3 text-[#111111] dark:text-[#ffffff]">feat: Ecossistema PHP & Laravel</h3>
                                <p class="text-sm mt-2 text-[#111111] dark:text-[#f3f3f3] leading-relaxed max-w-2xl">
                                    Construção e arquitetura de sistemas profissionais. Domínio na criação de APIs, MVC, Eloquent ORM e lógica de negócios robusta.
                                </p>
                            </div>

                            <div class="relative pl-8 group">
                                <div class="absolute -left-[14px] top-1 w-6 h-6 bg-[#e34f26] border-4 border-[#111111] dark:border-[#f3f3f3] rounded-full group-hover:scale-125 transition-transform"></div>
                                <span class="font-mono text-xs font-bold text-[#111111] bg-[#f3f3f3] border-2 border-[#111111] px-2 py-1 shadow-[2px_2px_0px_0px_#111111]">commit v1.0</span>
                                <h3 class="font-mono font-bold text-xl mt-3 text-[#111111] dark:text-[#ffffff]">init: Introdução ao Desenvolvimento Web</h3>
                                <p class="text-sm mt-2 text-[#111111] dark:text-[#f3f3f3] leading-relaxed max-w-2xl">
                                    Início da jornada na programação com foco nos fundamentos da web, estruturação de páginas e lógica de programação.
                                </p>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <div v-for="(projeto, index) in projetos" :key="index"
                                ...
                                <div class="relative w-full h-48 md:h-56 bg-[#f3f3f3] dark:bg-[#2a2a2a] mb-6 border-2 border-[#111111] flex items-center justify-center overflow-hidden cursor-pointer group/img" 
                                    ...
                                    <div v-if="projeto.imagem" class="absolute inset-0 bg-[#111111]/60 backdrop-blur-sm opacity-0 group-hover/img:opacity-100 transition-all duration-300 flex items-center justify-center">
                                        <i class="bi bi-zoom-in text-[#FFD60A] text-4xl drop-shadow-[2px_2px_0px_#111111]"></i>
                                    </div>
                                    
                                    <span v-else class="font-mono text-xs text-gray-500 font-bold tracking-widest">[ IMAGEM DO PROJETO ]</span>
                                </div>

                                <h3 class="inline-block px-2 py-1 font-mono font-bold text-xl mb-4 bg-[#111111] text-[#ffffff] dark:bg-transparent dark:text-[#ffffff] dark:group-hover:text-[#FFD60A] transition-colors self-start">
                                    {{ projeto.nome }}
                                </h3>
                ...
                <section id="sobre" class="min-h-[90vh] flex flex-col justify-start pt-12 pb-12">
                    <div class="space-y-16">
                        <div>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                                <div v-for="(hab, index) in sobreHabilidades" :key="index"
                                    ...
                                    <i :class="['bi text-2xl mb-2 block drop-shadow-[1px_1px_0px_#111111] dark:drop-shadow-none group-hover:scale-110 transition-transform', hab.icone, hab.cor]"></i>
                                    <h4 class="font-bold text-sm mb-1 text-[#111111] dark:text-[#ffffff]">{{ hab.nome }}</h4>
                                </div>
                            </div>
                        </div>

                        <div class="relative group">
                            <div class="absolute inset-0 bg-[#FFD60A] border-2 border-[#111111] dark:border-[#2a2a2a] translate-x-2 translate-y-2 transition-transform duration-300 group-hover:translate-x-3 group-hover:translate-y-3"></div>
                            <div class="relative border-2 border-[#111111] dark:border-[#2a2a2a] bg-[#111111] text-[#ffffff] p-8 md:p-12 shadow-none">
                                <div class="flex items-start gap-6">
                                    ...
                                    <div class="space-y-6 flex-grow">
                                        ...
                                        <p class="text-base md:text-lg leading-relaxed font-sans font-light text-[#f3f3f3]">
                                            Em evolução acelerada para o nível <span class="bg-[#FFD60A] text-[#111111] px-2 py-0.5 font-bold font-mono text-base shadow-[2px_2px_0px_0px_#ffffff]">Pleno</span>,
                                            busco consolidar um portfólio focado em <strong class="text-[#ffffff] border-b-2 border-[#FFD60A] pb-0.5">Engenharia de Software</strong>,
                                            <strong class="text-[#ffffff] border-b-2 border-[#FFD60A] pb-0.5">IA Aplicada</strong> e <strong class="text-[#ffffff] border-b-2 border-[#FFD60A] pb-0.5">Web Segurança</strong>.
                                        </p>
                                    </div>
                                </div>
                                
                                <div class="mt-8 border-2 border-[#ffffff] dark:border-[#2a2a2a] flex flex-col h-[400px] min-h-[250px] max-h-[75vh] resize-y overflow-hidden shadow-[4px_4px_0px_0px_#ffffff] dark:shadow-[4px_4px_0px_0px_#FFD60A]">
                                    <div class="bg-[#e2e2e2] dark:bg-[#2a2a2a] border-b-2 border-[#111111] px-4 py-2 flex items-center gap-2 flex-shrink-0">
                                        ...
                                        <span class="ml-4 font-mono text-xs font-bold text-[#111111] dark:text-[#ffffff]">elliton@wsl: ~</span>
                                    </div>
                        ...
                        <div class="pt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                            <a href="https://github.com/Elliton-Luis" target="_blank" class="group border-2 border-[#111111] dark:border-[#2a2a2a] bg-[#ffffff] dark:bg-[#111111] p-6 shadow-[6px_6px_0px_0px_#111111] dark:shadow-[6px_6px_0px_0px_#FFD60A] hover:-translate-y-2 hover:bg-[#111111] dark:hover:bg-[#111111] hover:shadow-[8px_8px_0px_0px_#555555] dark:hover:shadow-[8px_8px_0px_0px_#555555] dark:hover:border-[#2a2a2a] active:bg-[#111111] dark:active:bg-[#111111] active:text-[#ffffff] transition-all duration-300 text-center flex flex-col items-center justify-center">
                                <i class="bi bi-github text-4xl mb-4 text-[#111111] dark:text-[#ffffff] group-hover:text-[#ffffff] transition-colors"></i>
                                <p class="font-mono font-bold text-lg text-[#111111] dark:text-[#ffffff] group-hover:text-[#ffffff]">GitHub</p>
                            </a>
                            <a href="https://www.linkedin.com/in/elliton-luis-correia-da-silva-junior-9779452b3" target="_blank" class="group border-2 border-[#111111] dark:border-[#2a2a2a] bg-[#ffffff] dark:bg-[#111111] p-6 shadow-[6px_6px_0px_0px_#111111] dark:shadow-[6px_6px_0px_0px_#FFD60A] hover:-translate-y-2 hover:bg-[#0A66C2] dark:hover:bg-[#0A66C2] hover:shadow-[8px_8px_0px_0px_#0A66C2] dark:hover:shadow-[8px_8px_0px_0px_#0A66C2] transition-all duration-300 text-center flex flex-col items-center justify-center">
                                <i class="bi bi-linkedin text-4xl mb-4 text-[#0A66C2] dark:text-[#4a90e2] group-hover:text-[#ffffff] transition-colors"></i>
                                <p class="font-mono font-bold text-lg text-[#111111] dark:text-[#ffffff] group-hover:text-[#ffffff]">LinkedIn</p>
                            </a>
                            <a href="https://wa.me/75999488795" target="_blank" class="group border-2 border-[#111111] dark:border-[#2a2a2a] bg-[#ffffff] dark:bg-[#111111] p-6 shadow-[6px_6px_0px_0px_#111111] dark:shadow-[6px_6px_0px_0px_#FFD60A] hover:-translate-y-2 hover:bg-[#25D366] dark:hover:bg-[#25D366] hover:shadow-[8px_8px_0px_0px_#25D366] dark:hover:shadow-[8px_8px_0px_0px_#25D366] transition-all duration-300 text-center flex flex-col items-center justify-center">
                                <i class="bi bi-whatsapp text-4xl mb-4 text-[#25D366] dark:text-[#25D366] group-hover:text-[#ffffff] transition-colors"></i>
                                <p class="font-mono font-bold text-lg text-[#111111] dark:text-[#ffffff] group-hover:text-[#ffffff]">WhatsApp</p>
                            </a>
                        </div>
                    </div>
                </section>
            ...
            <div v-if="isImageModalOpen" class="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-sm p-4 sm:p-8 transition-opacity animate-fade-in" @click="closeImageModal">
                
                <button class="absolute top-4 right-4 sm:top-8 sm:right-8 w-12 h-12 flex items-center justify-center bg-[#FFD60A] border-2 border-[#111111] text-[#111111] text-2xl shadow-[4px_4px_0px_0px_#111111] hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_#111111] transition-all z-[101]" 
            ...
            <footer class="border-t-4 border-[#111111] dark:border-[#2a2a2a] bg-[#ffffff] dark:bg-[#111111] py-8 text-center transition-colors duration-300">
                <div class="container mx-auto px-6">
                    <p class="font-mono text-sm font-bold text-[#111111] dark:text-[#f3f3f3]">
                        Desenvolvido com <span class="text-[#42b883]">Vue.js</span> & TailwindCSS por Elliton Luís © {{ new Date().getFullYear() }}.
                    </p>
